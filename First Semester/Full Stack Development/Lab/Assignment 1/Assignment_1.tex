...
\begin{titlepage}
    ...
    \huge{\textsc{
            Tools for Digital Forensics and Investigation
        }} \\
...
https://www.vskills.in/certification/tutorial/digital-forensics-tools/
https://www.sleuthkit.org/index.php
https://study.com/learn/lesson/mobile-forensics-uses-tools-steps.html
\section{Platform}
